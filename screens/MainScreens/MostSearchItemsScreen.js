...
const MostSearchedItemsScreen = () => {
  ...
  const fetchClothes = async () => {
    try {
      ...
      const sortedData = data.sort((a, b) => b.search_count - a.search_count);
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      {/* <Text style={styles.searchCount}>Search Count: {item.search_count}</Text> */}
    </TouchableOpacity>
  );
...
export default MostSearchedItemsScreen;
